...
class DialogoTamano:
    def __init__(self, ventanaprincipal):
        ...
        #si apreta X
        self.dialogo.resizable(0,0) # no permite modificar tamaño dialogo
        self.dialogo.grab_set() #desactiva la ventana principal
    def mostrar(self):
        self.dialogo.wait_window() #muestra ventana dialogo
